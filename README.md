...
2. Install graphcool CLI via npm: _npm i -g graphcool@0.4_ (it is **important** that you install the version 0.4, because this is a legacy project)
...
5. Run _graphcool push_, now the scema should be successfully pushed
